...
//  Restaurant Solution
//
//  Created by Chase Robertson on 2/26/17.
...
class PaymentsViewController: UIViewController, STPPaymentContextDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return 8
        //TODO: return User.order.size()
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath)// as! PaymentsTableViewCell
        let product = "testproduct" //User.order.list[(indexPath as NSIndexPath).row]//Array(self.productsAndPrices.keys)[(indexPath as NSIndexPath).row]
        let price = 0.0 //product.price //self.productsAndPrices[product]!
...
//        cell.quantity = order.quantity
//            cell.name = "menu item name"+String(i)
//            cell.price = 10.58
//            cell.quantity = 1
        //}
    ...
    let stripePublishableKey = "pk_test_08bnxNQAytJZtQanlyERDtza"
    
    // 2) Next, optionally, to have this demo save your user's payment details, head to
    // https://github.com/stripe/example-ios-backend , click "Deploy to Heroku", and follow
    // the instructions (don't worry, it's free). Replace nil on the line below with your
    // Heroku URL (it looks like https://blazing-sunrise-1234.herokuapp.com ).
    let backendBaseURL: String? = "https://quiet-hollows-11633.herokuapp.com/"
